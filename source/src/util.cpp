...
#endif // ifndef WIN32
#include <sstream>
#include "wormnet/util.h"
#include "wormnet/utf8.h"
#include "wormnet/MersennetWister.h"
#include <stdarg.h>
...
WORM_DLL_EXPORT bool rand_odds(const uint16& wOdds)
{
    ...
    {
        return (mtRand.randInt(9999) < wOdds);
    }
}
...
WORM_DLL_EXPORT bool rand_odds(const int& nOdds)
{
    ...
    {
        return (mtRand.randInt(9999) < (uint16)nOdds);
    }
}
...
WORM_DLL_EXPORT bool rand_percent(const int& nOdds)
{
    ...
    {
        return (mtRand.randInt(99) < (uint16)nOdds);
    }
}
